...
"
"   Further customizations by Adam Hawkins.
"
"   - Use same background for gutter to reduce distraction
"   - Make splits, bars, and cursor bars all the same color as well as darken
" ==============================================================================
...
let g:colors_name="skylinesdark"
let colors_name="skylinesdark"
...
let s:white       = { "gui": "#d7d7d7",  "cterm": "188" }
...
let s:vertsplit   = { "gui": "#181818", "cterm": "237" }
let s:cursor_line = { "gui": "#181818", "cterm": "237" }
